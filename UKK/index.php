...
<head>
    ...
    <style>
        ...
        ul {
            ...
            padding: 0;
            overflow: hidden;
            background-image: linear-gradient( #EE4C7C, #DB7093);
        }
        ...
        th {
            background-image: linear-gradient( #EE4C7C, #C71585);
            color: white;
        }
...
<body>
    ...
    <footer>Copyright By Narnia Farazh</footer>
</body>
</html>
